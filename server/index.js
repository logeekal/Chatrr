...
const app = express();
app.use(cookieSession(SECRET.COOKIE_SESSION_OPTS));
    ...
    onConnect: (connectionParams, webSocket) => {
      ...
      try {
        const existingsession = JSON.parse(
          Buffer.from(existingCookie.get("userCookie"), "base64").toString()
        );
...
server.listen(3001, () => {
  console.log(
    `🚀 Server ready at http://localhost:${3001}${gqlServer.graphqlPath}`
  );
  console.log(
    `🚀 Subscriptions ready at ws://localhost:${3001}${
